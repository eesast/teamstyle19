...
struct Soldier {
    ...
    Soldier();
    Soldier(SoldierName soldier_name, int heal, Position pos, int flag);
};
...
//API for players
void updateAge();
void construct(BuildingType building_type, Position pos, Position soldier_pos); //The soldier position is not set now
